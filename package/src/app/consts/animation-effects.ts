    ...
    uldor: {
        in: {
            ...
            path: {
                duration: 900,
                easing: 'easeOutElastic',
                d: 'M 33.5, 31 C 33.5, 31 145, 31 200, 31 256, 31 367, 31 367, 31 367, 31 367, 110 367, 150 367, ' +
                   '190 367, 269 367, 269 367, 269 256, 269 200, 269 145, 269 33.5, 269 33.5, 269 33.5, 269 33.5, 190 ' +
                   '33.5, 150 33.5, 110 33.5, 31 33.5, 31 Z'
            },
            content: {
                duration: 900,
                easing: 'easeOutElastic',
        ...
        out: {
            ...
            path: {
                duration: 200,
                easing: 'easeOutQuint',
                d: 'M 79.5, 66 C 79.5, 66 128, 106 202, 105 276, 104 321, 66 321, 66 321, 66 287, 84 288, 155 289, 226 ' +
                '318, 232 318, 232 318, 232 258, 198 200, 198 142, 198 80.5, 230 80.5, 230 80.5, 230 112, 222 111, 152 110,' +
                ' 82 79.5, 66 79.5, 66 Z'
            },
            content: {
                duration: 100,
                easing: 'easeOutQuint',
    ...
    dori: {
        in: {
            ...
            path: {
                ...
                easing: 'easeOutElastic',
                elasticity: 700,
                d: 'M 22, 74.2 22, 202 C 22, 202 82, 202 103, 202 124, 202 184, 202 184, 202 L 200, 219 216, 202 C 216, ' +
                '202 274, 202 297, 202 320, 202 378, 202 378, 202 L 378, 74.2 C 378, 74.2 318, 73.7 200, 73.7 82, 73.7 22, ' +
                '74.2 22, 74.2 Z'
            },
            content: {
                duration: 300,
        ...
        out: {
            ...
            path: {
                duration: 200,
                easing: 'easeInQuad',
                d: 'M 22, 108 22, 236 C 22, 236 64, 216 103, 212 142, 208 184, 212 184, 212 L 200, 229 216, 212 C 216, ' +
                '212 258, 207 297, 212 336, 217 378, 236 378, 236 L 378, 108 C 378, 108 318, 83.7 200, 83.7 82, 83.7 22, 108 22, 108 Z'
            },
            content: {
                duration: 100,
                easing: 'easeInQuad',
    ...
    gram: {
        in: {
            ...
            path: {
                duration: 600,
                easing: 'easeOutQuint',
                d: 'M 92.4, 79 C 136, 79 156, 79.1 200, 79.4 244, 79.7 262, 79 308, 79 354, 79 381, 111 381, 150 381, 189 ' +
                '346, 220 308, 221 270, 222 236, 221 200, 221 164, 221 130, 222 92.4, 221 54.4, 220 19, 189 19, 150 19, 111 ' +
                '48.6, 79 92.4, 79 Z'
            },
            content: {
                delay: 100,
        ...
        out: {
            ...
            path: {
                duration: 200,
                easing: 'easeInQuint',
                d: 'M 92.4, 79 C 136, 79 154, 115 200, 116 246, 117 263, 80.4 308, 79 353, 77.6 381, 111 381, 150 381, ' +
                '189 346, 220 308, 221 270, 222 236, 188 200, 188 164, 188 130, 222 92.4, 221 54.4, 220 19, 189 19, 150 19, ' +
                '111 48.6, 79 92.4, 79 Z'
            },
            content: {
                duration: 150,
                easing: 'easeInQuint',
    ...
    indis: {
        in: {
            ...
            path: {
                ...
                d: 'M 44.5, 24 C 148, 24 252, 24 356, 24 367, 24 376, 32.9 376, 44 L 376, 256 C 376, 267 367, 276 356, 276 ' +
                '252, 276 148, 276 44.5, 276 33.4, 276 24.5, 267 24.5, 256 L 24.5, 44 C 24.5, 32.9 33.4, 24 44.5, 24 Z'
            },
            content: {
                duration: 300,
                delay: 50,
        ...
        out: {
            ...
            path: {
                ...
                delay: 50,
                easing: 'easeInOutQuint',
                d: 'M 44.5, 24 C 138, 4.47 246, -6.47 356, 24 367, 26.9 376, 32.9 376, 44 L 376, 256 C 376, 267 367, ' +
                '279 356, 276 231, 240 168, 241 44.5, 276 33.8, 279 24.5, 267 24.5, 256 L 24.5, 44 C 24.5, 32.9 33.6, 26.3 44.5, 24 Z'
            },
            content: {
                duration: 300,
                easing: 'easeInOutQuad',
